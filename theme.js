/* Theme switch, shared with the other Innovatory sites.
 *
 * Same preference key, so a reader who picked light on scratchd.net gets
 * light here too. Only the background colours differ, because the
 * theme-color meta has to match this site's own background.
 *
 ...
 * switch and the site stays light, which is the default in the stylesheet.
 */
(function () {
  'use strict';
  ...
  var BG = { light: '#f8f7ff', dark: '#12131b' };
